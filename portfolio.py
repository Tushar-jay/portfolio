...
with tab1:
    ...
    with col2:
        ...
        try:
            with open("Tushar Dasgupta_CV.pdf", "rb") as f:
                st.download_button("📄 Download Resume", f, file_name="Tushar Dasgupta_CV.pdf")
        except FileNotFoundError:
            st.error("⚠️ Resume not found. Please place 'Tushar Dasgupta_CV.pdf' in the same folder.")
